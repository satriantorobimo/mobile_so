...
class BarsChartDetail extends StatefulWidget {
  const BarsChartDetail({super.key, required this.code, required this.date});
  final String code;
  final String date;

  @override
  State<BarsChartDetail> createState() => _BarsChartDetailState();
}

class _BarsChartDetailState extends State<BarsChartDetail> {
  BarBloc barBloc = BarBloc(dashboardRepo: DashboardRepo());
  @override
  void initState() {
    barBloc.add(BarCalendartAttempt(widget.code, widget.date));
    super.initState();
  }
