...
class AssetOpnameListDetailScreen extends StatefulWidget {
  const AssetOpnameListDetailScreen({super.key, required this.code});
  final String code;

  @override
  State<AssetOpnameListDetailScreen> createState() =>
      _AssetOpnameListDetailScreenState();
}

class _AssetOpnameListDetailScreenState
    extends State<AssetOpnameListDetailScreen> {
  String name = '';
  String uid = '';
  String company = '';
  ...
  @override
  void initState() {
    assetOpnameListBloc.add(AssetOpnameLisDetailtAttempt(widget.code));
    getUserData();
    super.initState();
  }
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                AutoSizeText('Asset Opname List',
                    style: TextStyle(
          ...
          BlocListener(
              ...
              child: BlocBuilder(
                  ...
                  builder: (context, AssetOpnameListState state) {
                    ...
                    if (state is AssetOpnameListDetailLoaded) {
