...
class DocPreviewNetworkPdfScreen extends StatefulWidget {
  final DocPreviewRequestModel docPreviewRequestModel;
  const DocPreviewNetworkPdfScreen(this.docPreviewRequestModel, {super.key});

  @override
  State<DocPreviewNetworkPdfScreen> createState() =>
      _DocPreviewAssetScreenState();
}

class _DocPreviewAssetScreenState extends State<DocPreviewNetworkPdfScreen> {
  ...
  Future<File> _createPdfFile(String base64String) async {
    try {
